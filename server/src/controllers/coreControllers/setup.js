...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      nexus_app_email: email,
      nexus_app_company_email: email,
      nexus_app_timezone: timezone,
      nexus_app_country: country,
      nexus_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully Nexus Business Suite Setup',
  });
};
